...
![image-20200129150901662](参考/09-静态static关键字概述.png)
...
![](参考/13-super与this的内存图1.png)

![](参考/13-super与this的内存图.png)
...
![image-20200131151213482](参考/16-发红包案例的分析1.png)
...
4. `RedPacket`对象，设置红包类型。`setOpenMode(OpenMode openMode)`，是接口作为参数。我们必须定义接口的实现类，重写接口中方法，并传 递实现类对象到`setOpenMode`方法中，方可设置完成。再观察接口：
