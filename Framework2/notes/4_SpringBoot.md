...
- 4.1[SpringBoot简介](#4.1-SpringBoot简介)
- 4.2[SpringBoot快速入门](#4.2-SpringBoot快速入门)

- 4.3[SpringBoot原理分析](#4.3-SpringBoot原理分析)

- 4.4[SpringBoot的配置文件](#4.4-SpringBoot的配置文件)

- 4.5[SpringBoot与整合其他技术](#4.5-SpringBoot与整合其他技术)

- 4.6[SpringBoot整合SpringDataJPA](#4.6-SpringBoot整合SpringDataJPA)

- 4.7[SpringBoot整合Redis](#4.7-SpringBoot整合Redis)
...
2018-05-08 14:29:59.714  INFO 5672 --- [           main] MySpringBootApplication      : Starting MySpringBootApplication on DESKTOP-RRUNFUH with PID 5672 
... ... ...
...
2018-05-08 14:30:03.206  INFO 5672 --- [           main] demo.MySpringBootApplication      : Started MySpringBootApplication in 4.252 seconds (JVM running for 5.583)
```
...
#spring集成Mybatis环境
#pojo别名扫描包
mybatis.type-aliases-package=demo.domain
#加载Mybatis映射文件
...
import demo.MySpringBootApplication;
...
## 5.5.3 SpringBoot整合SpringDataJPA
