package com.heixin.search.service;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.heixin.item.pojo.*;
import com.heixin.search.client.BrandClient;
import com.heixin.search.client.CategoryClient;
import com.heixin.search.client.GoodsClient;
import com.heixin.search.client.SpecificationClient;
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        params.forEach(param -> {
            ...
            if (param.getGeneric()){
                ...
                specs.put(param.getName(),values);
            }
        });
...
//        return brands;
    ...
    private List<Map<String, Object>> getCategoryAggResult(Aggregation aggregation) {
        ...
        return terms.getBuckets().stream().map(bucket -> {
            ...
            //根据分类id查询分类名称
            List<String> names = this.categoryClient.queryNamesByIds(Collections.singletonList(id));
            map.put("id",id);
